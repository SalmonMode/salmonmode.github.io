...
excerpt: "A collection of testing maxims, tips, and gotchas, with some pytest-specific tips. Things to do and not to do when it comes to writing automated tests."
---
...
### Group tests based on the behavior they're testing
